...
module.exports = {
    ...
    async executor(message) {
        ...
        const reply = function(mesaj) {
            ...
            .setFooter({text:"Made By Coder#5700"})
    ...
    if(ayarlar.bakim === "1") return await reply(`Bot bakıma alındı en kısa sürede aktif olucaktır. Made By <@971029494875955240>`)
